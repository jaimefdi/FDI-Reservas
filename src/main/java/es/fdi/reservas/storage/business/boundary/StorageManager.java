package es.fdi.reservas.storage.business.boundary;
...
import es.fdi.reservas.domain.events.Action1;
import es.fdi.reservas.storage.business.control.StorageObjectRepository;
import es.fdi.reservas.storage.business.entity.*;
