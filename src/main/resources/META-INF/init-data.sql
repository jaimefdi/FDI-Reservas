...
INSERT INTO GrupoReserva(GrupoReservaId, nombreGrupo, descripcion) VALUES(1,'GII-1ºA','Lo que sea');
INSERT INTO GrupoReserva(GrupoReservaId, nombreGrupo, descripcion) VALUES(2,'GII-1ºB','Lo que sea');
INSERT INTO GrupoReserva(GrupoReservaId, nombreGrupo, descripcion) VALUES(3,'GII-1ºC','Lo que sea');
INSERT INTO GrupoReserva(GrupoReservaId, nombreGrupo, descripcion) VALUES(4,'GII-1ºD','Lo que sea');
INSERT INTO GrupoReserva(GrupoReservaId, nombreGrupo, descripcion) VALUES(5,'GII-1ºE','Lo que sea');
INSERT INTO GrupoReserva(GrupoReservaId, nombreGrupo, descripcion) VALUES(6,'GII-1ºF','Lo que sea');

INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(1,'Charla Intel','2016-03-16 12:30:00','2016-03-16 14:30:00',0,'user',1,1);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(2,'Reunion TFG','2016-03-16 14:30:00','2016-03-16 16:30:00',2,'user',3,1);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(3,'Rvision examen','2016-03-18 14:30:00','2016-03-18 16:30:00',0,'user',4,1);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(4,'Tutoria','2016-03-17 14:30:00','2016-03-17 16:30:00',1,'user',3,2);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(5,'Clase de repaso','2016-03-23 14:30:00','2016-03-23 16:30:00',1,'user',5,2);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(6,'PL','2016-03-07 09:00:00','2016-03-07 11:00:00',0,'user',6,2);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(7,'PL','2016-03-09 09:00:00','2016-03-09 11:00:00',0,'user',6,1);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(8,'MAR','2016-03-09 11:00:00','2016-03-09 12:00:00',0,'user',6,2);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(9,'DVI','2016-03-09 14:00:00','2016-03-09 16:00:00',0,'user',6,1);
INSERT INTO Reserva(ReservaId, asunto, comienzo, fin, estadoReserva, username, EspacioId, GrupoReservaId) VALUES(10,'Charla ELP','2016-03-24 15:30:00','2016-03-24 17:00:00',1,'user',1,1);
